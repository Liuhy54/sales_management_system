...
public class Generator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/crm?serverTimezone=Asia/Shanghai", "root", "lhynb54")
                .globalConfig(builder -> {
                    builder.author("gxm")// 设置作者
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("t_user") // 设置需要生成的表名
                            ...
                            .columnNaming(NamingStrategy.underline_to_camel)//数据库表字段映射到实体的命名策略: 驼峰
